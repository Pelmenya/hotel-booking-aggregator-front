export const PrivacyPolicyPage = () => {
    ...
    const siteDomen = siteUrl.trim().split('//')[1];

    return (
        <ol className="policy py-10">
            <li>
                <span className="font-bold">Общие положения</span>.
                <ol className="policy pl-8">
                    <li>
                        ...
                        порядок обработки персональных данных и меры по
                        обеспечению безопасности персональных данных,
                        предпринимаемые Ляпиным Дмитрием Сергеевичем (далее –
                        Оператор).
                    </li>
                    <li>
            ...
            <li>
                ...
                <ol className="policy pl-8">
                    ...
                    <li>
                        ...
                        Пользователю веб-сайта {`${siteUrl}`}.
                    </li>
                    <li>
                ...
                <ol className="policy pl-8">
                    <li>
                        ...
                        <ol className="policy pl-8">
                            ...
                            <li>
                                Cамостоятельно определять состав и перечень мер,
                    ...
                    <li>
                        ...
                        <ol className="policy pl-8">
                            <li>
                                ...
                                его просьбе информацию, касающуюся обработки его
                                персональных данных
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                органа необходимую информацию в течение 30 дней
            ...
            <li>
                ...
                <ol className="policy pl-8">
                    <li>
                        ...
                        <ol className="policy pl-8">
                            <li>
                                ...
                                содержаться персональные данные, относящиеся к
                                другим субъектам персональных данных, за
                                исключением случаев, когда имеются законные
                                основания для раскрытия таких персональных
                                данных. Перечень информации и порядок ее
                                получения установлен Законом о персональных
                                данных.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                обработке персональных данных в целях
                            ...
                            <li>
                                ...
                                субъектов персональных данных или в судебном
                                порядке неправомерные действия или бездействие
                    ...
                    <li>
                        Лица, передавшие Оператору недостоверные сведения о
            ...
            <li>
                ...
                <ol className="policy pl-8">
                    ...
                    <li>
                        бработка персональных данных, разрешенных для
                    ...
                    <li>
                        ...
                        других согласий на обработку его персональных данных.
                        При этом соблюдаются условия, предусмотренные, в
                        ...
                        <ol className="policy pl-8">
                            ...
                            <li>
                                ...
                                требования, указанного в п. 5.8.3 настоящей
                                Политики в отношении обработки персональных
                                данных.
                            </li>
                        </ol>
                    </li>
            ...
            <li>
                ...
                <ol className="policy pl-8">
                    ...
                    <li>
                        ...
                        допускается обработка персональных данных, несовместимая
                    ...
                    <li>
                        ...
                        которого, выгодоприобретателем или поручителем по
                ...
                <ol className="policy pl-8">
                    <li>
                        ...
                        <ol className="policy pl-8">
                            ...
                            <li>
                                Федеральные законы, иные нормативно-правовые
                                акты в сфере защиты персональных данных.
                            </li>
                            <li>
                                Согласия Пользователей на обработку их
                                персональных данных, на обработку персональных
                                данных, разрешенных для распространения.
                            </li>
                        </ol>
                    </li>
                    <li>
                        ...
                        только в случае их заполнения и/или отправки
                        Пользователем самостоятельно через специальные формы,
                        расположенные на сайте {`${siteUrl}`} или направленные
                        Оператору посредством электронной почты. Заполняя
                    ...
                    <li>
                        Субъект персональных данных самостоятельно принимает
            ...
            <li>
                ...
                <ol className="policy pl-8">
                    ...
                    <li>
                        ...
                        целей, предусмотренных международным договором
                    ...
                    <li>
                        ...
                        персональных данных, а также для заключения договора по
            ...
            <li>
                ...
                <ol className="policy pl-8">
                    ...
                    <li>
                        ...
                        info@engineering-solutions.su с пометкой «Актуализация
                        персональных данных»
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        данных или отзыв согласия субъектом персональных данных,
            ...
            <li>
                <span className="font-bold">Заключительные положения.</span>
                <ol className="policy pl-8">
                    <li>
                        ...
                        электронной почты info@{`${siteDomen}`}.
                    </li>
                    <li>
