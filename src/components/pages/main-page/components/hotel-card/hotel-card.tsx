...
export const HotelCard = ({ title, id, description, images, onClick }: THotelCardProps) => {
    return (
        <div id={id} onClick={() => onClick(id)} className="card card-side bg-base-200 shadow-xl rounded-3xl gap-4 cursor-pointer">
